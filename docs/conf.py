...
#
try:
    from nsupdate import version as _nsu_version, version_tuple as _nsu_version_tuple
    # The full version, including alpha/beta/rc tags.
    release = _nsu_version
    # The short X.Y version.
    version = '%d.%d' % _nsu_version_tuple[:2]
except Exception:
    # Fallback if package can't be imported (e.g., without installing the package)
    release = os.environ.get('NSUPDATE_VERSION', '0.0')
    parts = release.split('.')
    version = '.'.join(parts[:2]) if parts else '0.0'
