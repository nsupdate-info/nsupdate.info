...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Host.ssl_update_ipv6'
        db.rename_column(u'main_host', 'ssl_update_ipv6', 'tls_update_ipv6')

        # Renaming field 'Host.ssl_update_ipv4'
        db.rename_column(u'main_host', 'ssl_update_ipv4', 'tls_update_ipv4')
    ...
    def backwards(self, orm):
        ...
        # Renaming field 'Host.tls_update_ipv4'
        db.rename_column(u'main_host', 'tls_update_ipv4', 'ssl_update_ipv4')

        # Renaming field 'Host.tls_update_ipv6'
        db.rename_column(u'main_host', 'tls_update_ipv6', 'ssl_update_ipv6')
