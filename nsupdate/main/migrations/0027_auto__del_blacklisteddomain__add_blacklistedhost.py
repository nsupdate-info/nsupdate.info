...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Rename model 'BlacklistedDomain'
        db.rename_table(u'main_blacklisteddomain', u'main_blacklistedhost')

    def backwards(self, orm):
        # Rename model 'BlacklistedHost'
        db.rename_table(u'main_blacklistedhost', u'main_blacklisteddomain')
