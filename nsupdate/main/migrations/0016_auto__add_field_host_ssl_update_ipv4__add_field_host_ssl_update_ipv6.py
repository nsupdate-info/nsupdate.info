...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.ssl_update_ipv4'
        db.add_column(u'main_host', 'ssl_update_ipv4',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Host.ssl_update_ipv6'
        db.add_column(u'main_host', 'ssl_update_ipv6',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.ssl_update_ipv4'
        db.delete_column(u'main_host', 'ssl_update_ipv4')

        # Deleting field 'Host.ssl_update_ipv6'
        db.delete_column(u'main_host', 'ssl_update_ipv6')
