...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Host.last_update_ipv4'
        db.add_column(u'main_host', 'last_update_ipv4',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Host.last_update_ipv6'
        db.add_column(u'main_host', 'last_update_ipv6',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Host.last_update_ipv4'
        db.delete_column(u'main_host', 'last_update_ipv4')

        # Deleting field 'Host.last_update_ipv6'
        db.delete_column(u'main_host', 'last_update_ipv6')
