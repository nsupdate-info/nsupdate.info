...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Host.netmask_ipv4'
        db.alter_column(u'main_host', 'netmask_ipv4', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'Host.netmask_ipv6'
        db.alter_column(u'main_host', 'netmask_ipv6', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

    def backwards(self, orm):

        # Changing field 'Host.netmask_ipv4'
        db.alter_column(u'main_host', 'netmask_ipv4', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Host.netmask_ipv6'
        db.alter_column(u'main_host', 'netmask_ipv6', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'main.host': {
            ...
            'netmask_ipv4': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '32'}),
            'netmask_ipv6': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '64'}),
