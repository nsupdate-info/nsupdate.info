...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.netmask_ipv4'
        db.add_column(u'main_host', 'netmask_ipv4',
                      self.gf('django.db.models.fields.IntegerField')(default=32),
                      keep_default=False)

        # Adding field 'Host.netmask_ipv6'
        db.add_column(u'main_host', 'netmask_ipv6',
                      self.gf('django.db.models.fields.IntegerField')(default=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.netmask_ipv4'
        db.delete_column(u'main_host', 'netmask_ipv4')

        # Deleting field 'Host.netmask_ipv6'
        db.delete_column(u'main_host', 'netmask_ipv6')
    ...
    models = {
        ...
        u'main.host': {
            ...
            'netmask_ipv4': ('django.db.models.fields.IntegerField', [], {'default': '32'}),
            'netmask_ipv6': ('django.db.models.fields.IntegerField', [], {'default': '64'}),
